...
sudo apt-get install -y \
  nvidia-driver-570-server-open=570.172.08-0lambda0.22.04.1 \
  nvidia-dkms-570-server-open=570.172.08-0lambda0.22.04.1 \
  nvidia-utils-570-server=570.172.08-0lambda0.22.04.1 \
  libnvidia-gl-570-server=570.172.08-0lambda0.22.04.1 \
  libnvidia-compute-570-server=570.172.08-0lambda0.22.04.1 \
  nvidia-fabricmanager-570=570.172.08-0lambda0.22.04.1
...
python rerender/build_benchmark.py --process_all
