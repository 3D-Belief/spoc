...
from spoc_utils.constants.objaverse_data_dirs import OBJAVERSE_ASSETS_DIR
...
INTEL_CAMERA_WIDTH, INTEL_CAMERA_HEIGHT = 240, 320


# INTEL_WIDTH_CROPPED, INTEL_HEIGHT_CROPPED = 384, 224
# INTEL_VERTICAL_FOV = 59
# INTEL_VERTICAL_FOV = 55.42
# INTEL_VERTICAL_FOV = 120.0
INTEL_VERTICAL_FOV = 85.533
